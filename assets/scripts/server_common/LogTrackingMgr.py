...
class LogTrackingMgr:
    # 用户属性主号限定
    @staticmethod
    def Server_User_Set_Main(GBID, distinctId, player_gid, player_uid, **kwargs):
        args = {}
        args["#account_id"] = GBID
        args["#distinct_id"] = distinctId
        args["#type"] = "user_set"
        args["#event_name"] = "Server_User_Set_Main"
    ...
    # 用户属性通用
    @staticmethod
    def Server_User_Set(GBID, distinctId, player_obid, channel, platform, server_id, gender, role_id, role_class, role_name, role_create_time, game_id, online, enemy_num, role_order, first_login_time, last_login_time, current_bind_yuanbao, current_copper, current_experience, current_guild_contribution, current_xuantie, current_yuanbao, current_guild_id, current_guild_name, current_level, current_map_id, current_power, current_level_rank, current_score_rank, current_achievement_rank, month_bcard_invoke, month_bcard_left, month_scard_invoke, month_scard_left, total_login_day, total_online_time, friends_num, last_login_out_time, **kwargs):
        args = {}
        args["#account_id"] = GBID
        args["#distinct_id"] = distinctId
        args["#type"] = "user_set"
        ...
        args["current_guild_id"] = str(current_guild_id)
        ...
        args["last_login_out_time"] = last_login_out_time
        LogTrackingMgr.LOG(args, kwargs)
    ...
    # 公会信息事件
    @staticmethod
    def Guild_Info(GBID, distinctId, guild_uuid, level, guild_exp, fund_num, gold_num, guild_commission, guild_iron_mine, token_num, src, op_uuid, desc, **kwargs):
        args = {}
        args["#account_id"] = GBID
        args["#distinct_id"] = distinctId
        args["#type"] = "track"
        ...
        args["guild_iron_mine"] = guild_iron_mine
    ...
    # 归墟事件
    @staticmethod
    def Abyss_Info(GBID, distinctId, gb_id, game_id, floor, map_id, abyss_event, left_time, from_server_id, cross_server_id, **kwargs):
        args = {}
        args["#account_id"] = GBID
        args["#distinct_id"] = distinctId
        args["#type"] = "track"
        args["#event_name"] = "Abyss_Info"
        args["gb_id"] = str(gb_id)
        args["game_id"] = str(game_id)
        args["floor"] = floor
        args["map_id"] = map_id
        args["abyss_event"] = abyss_event
        args["left_time"] = left_time
        args["from_server_id"] = from_server_id
        args["cross_server_id"] = cross_server_id
        LogTrackingMgr.LOG(args, kwargs)
    ...
    # 装备铭文
    @staticmethod
    def equip_glyph(GBID, distinctId, op_uuid, op_type, gb_id, unique_id, equip_id, equip_name, equip_type, equip_grade, equip_quality, equip_belong_to, equip_attrs, equip_attrs_after, consumed_item_bind_value, equip_power, glyph_ref_id, glyph_pos, bind_type_before, bind_type_after, is_auto, **kwargs):
        args = {}
        args["#account_id"] = GBID
        args["#distinct_id"] = distinctId
        args["#type"] = "track"
        ...
        args["bind_type_before"] = bind_type_before
        args["bind_type_after"] = bind_type_after
        args["is_auto"] = is_auto
        LogTrackingMgr.LOG(args, kwargs)
    ...
    # 月卡事件
    @staticmethod
    def MonthCard_Invoke(GBID, distinctId, gb_id, level, invoke_time, expire_time, op_uuid, card_id, **kwargs):
        args = {}
        args["#account_id"] = GBID
        args["#distinct_id"] = distinctId
        args["#type"] = "track"
    ...
    # 礼包购买
    @staticmethod
    def Gift_Buy(GBID, distinctId, gb_id, buy_package__id, op_uuid, limit_type, limit_count, bought_count, currency_id, cost_num, **kwargs):
        args = {}
        args["#account_id"] = GBID
        args["#distinct_id"] = distinctId
        args["#type"] = "track"
    ...
    # 货币兑换
    @staticmethod
    def Currency_Exchange(GBID, distinctId, gb_id, exchange_id, op_uuid, daily_limit, daily_used_before, daily_used_after, account_id, ob_id, **kwargs):
        args = {}
        args["#account_id"] = GBID
        args["#distinct_id"] = distinctId
        args["#type"] = "track"
    ...
    # 商店购买
    @staticmethod
    def Store_Buy(GBID, distinctId, gb_id, mall_id, mall_type, product_id, real_item_id, item_num, limit_type, limit_num, buy_num, cost_info, op_uuid, account_id, ob_id, **kwargs):
        args = {}
        args["#account_id"] = GBID
        args["#distinct_id"] = distinctId
        args["#type"] = "track"
    ...
    # 帮会副本开启
    @staticmethod
    def Guild_BossChallenge_Open(GBID, distinctId, op_uuid, guild_uuid, job, open_type, consume_type, consume_count, open_dungeon_id, open_time, opened_money_count, opened_fund_count, guild_dungeon_open_role_id, guild_dungeon_open_role_name, **kwargs):
        args = {}
        args["#account_id"] = GBID
        args["#distinct_id"] = distinctId
        args["#type"] = "track"
    ...
    # 传送
    @staticmethod
    def teleport(GBID, distinctId, account_id, from_map_id, to_map_id, **kwargs):
        args = {}
        args["#account_id"] = GBID
        args["#distinct_id"] = distinctId
        args["#type"] = "track"
    ...
    # 任务状态变更
    @staticmethod
    def Task_State_Change(GBID, distinctId, gb_id, task_id, task_state, task_type, task_map, player_level, op_uuid, **kwargs):
        args = {}
        args["#account_id"] = GBID
        args["#distinct_id"] = distinctId
        args["#type"] = "track"
    ...
    # 更新经验
    @staticmethod
    def Update_Exp(GBID, distinctId, gb_id, delta_val, modify_val, op_uuid, src, space_no, level, exp_sub_source, exp, exp_before, **kwargs):
        args = {}
        args["#account_id"] = GBID
        args["#distinct_id"] = distinctId
        args["#type"] = "track"
    ...
    # 经脉升级
    @staticmethod
    def Meridian_UpGrade(GBID, distinctId, op_uuid, gb_id, meridian_id, point_id, new_level, cost_item_info, **kwargs):
        args = {}
        args["#account_id"] = GBID
        args["#distinct_id"] = distinctId
        args["#type"] = "track"
    ...
    # 经脉强化
    @staticmethod
    def Meridian_Enhance(GBID, distinctId, op_uuid, gb_id, meridian_id, cost_item_info, **kwargs):
        args = {}
        args["#account_id"] = GBID
        args["#distinct_id"] = distinctId
        args["#type"] = "track"
    ...
    # 删除保管箱记录
    @staticmethod
    def delete_stash(GBID, distinctId, order_id, player_gbid, goods_id, record_deleted, record_deleted_time, is_gm, **kwargs):
        args = {}
        args["#account_id"] = GBID
        args["#distinct_id"] = distinctId
        args["#type"] = "track"
    ...
    # 角色改名
    @staticmethod
    def role_rename(GBID, distinctId, rename_time, role_name_old, role_name_new, **kwargs):
        args = {}
        args["#account_id"] = GBID
        args["#distinct_id"] = distinctId
        args["#type"] = "track"
        args["#event_name"] = "role_rename"
        args["rename_time"] = str(rename_time)
        args["role_name_old"] = str(role_name_old)
        args["role_name_new"] = str(role_name_new)
        LogTrackingMgr.LOG(args, kwargs)

    # 矿战胜利帮会
    @staticmethod
    def mine_war_win_guild(GBID, distinctId, guild_uuid, guild_name, **kwargs):
        args = {}
        args["#account_id"] = GBID
        args["#distinct_id"] = distinctId
        args["#type"] = "track"
        args["#event_name"] = "mine_war_win_guild"
        args["guild_uuid"] = str(guild_uuid)
        args["guild_name"] = str(guild_name)
        LogTrackingMgr.LOG(args, kwargs)
    ...
    # 矿战胜利帮会成员
    @staticmethod
    def mine_war_win_guild_member(GBID, distinctId, job, guild_uuid, **kwargs):
        args = {}
        args["#account_id"] = GBID
        args["#distinct_id"] = distinctId
        args["#type"] = "track"
        args["#event_name"] = "mine_war_win_guild_member"
        args["job"] = str(job)
        args["guild_uuid"] = str(guild_uuid)
        LogTrackingMgr.LOG(args, kwargs)
    ...
    # 喇叭
    @staticmethod
    def horn_msg(GBID, distinctId, cost_item_id, cost_item_num, msg_length, **kwargs):
        args = {}
        args["#account_id"] = GBID
        args["#distinct_id"] = distinctId
        args["#type"] = "track"
        args["#event_name"] = "horn_msg"
        args["cost_item_id"] = cost_item_id
        args["cost_item_num"] = cost_item_num
        args["msg_length"] = msg_length
        LogTrackingMgr.LOG(args, kwargs)

    # 组队语音
    @staticmethod
    def team_voice_state_change(GBID, distinctId, new_status, member_count, **kwargs):
        args = {}
        args["#account_id"] = GBID
        args["#distinct_id"] = distinctId
        args["#type"] = "track"
        args["#event_name"] = "team_voice_state_change"
    ...
    # 组队语音禁言
    @staticmethod
    def team_voice_state_forbid(GBID, distinctId, target_player_id, mute_type, **kwargs):
        args = {}
        args["#account_id"] = GBID
        args["#distinct_id"] = distinctId
        args["#type"] = "track"
    ...
    # 帮会语音
    @staticmethod
    def guild_voice_state(GBID, distinctId, new_status, guild_member_online, **kwargs):
        args = {}
        args["#account_id"] = GBID
        args["#distinct_id"] = distinctId
        args["#type"] = "track"
        args["#event_name"] = "guild_voice_state"
        args["new_status"] = new_status
        args["guild_member_online"] = guild_member_online
        LogTrackingMgr.LOG(args, kwargs)

    # 帮会语音禁言
    @staticmethod
    def guild_voice_forbid(GBID, distinctId, target_player_id, is_forbid, **kwargs):
        args = {}
        args["#account_id"] = GBID
        args["#distinct_id"] = distinctId
        args["#type"] = "track"
    ...
    # 帮会语音进出
    @staticmethod
    def guild_voice_member_change(GBID, distinctId, action_type, **kwargs):
        args = {}
        args["#account_id"] = GBID
        args["#distinct_id"] = distinctId
        args["#type"] = "track"
        args["#event_name"] = "guild_voice_member_change"
        args["action_type"] = action_type
        LogTrackingMgr.LOG(args, kwargs)

    # 进入归墟
    @staticmethod
    def abyss_enter(GBID, distinctId, abyss_enter_floor_id, abyss_enter_time, abyss_cost_ticket_id, abyss_cost_ticket_num, **kwargs):
        args = {}
        args["#account_id"] = GBID
        args["#distinct_id"] = distinctId
        args["#type"] = "track"
        args["#event_name"] = "abyss_enter"
        args["abyss_enter_floor_id"] = abyss_enter_floor_id
        args["abyss_enter_time"] = abyss_enter_time
        args["abyss_cost_ticket_id"] = abyss_cost_ticket_id
        args["abyss_cost_ticket_num"] = abyss_cost_ticket_num
        LogTrackingMgr.LOG(args, kwargs)

    # 离开归墟
    @staticmethod
    def abyss_leave(GBID, distinctId, abyss_leave_time, **kwargs):
        args = {}
        args["#account_id"] = GBID
        args["#distinct_id"] = distinctId
        args["#type"] = "track"
        args["#event_name"] = "abyss_leave"
        args["abyss_leave_time"] = abyss_leave_time
        LogTrackingMgr.LOG(args, kwargs)

    # 归墟买门票
    @staticmethod
    def abyss_ticketBuy(GBID, distinctId, abyss_buy_ticket_method, **kwargs):
        args = {}
        args["#account_id"] = GBID
        args["#distinct_id"] = distinctId
        args["#type"] = "track"
        args["#event_name"] = "abyss_ticketBuy"
        args["abyss_buy_ticket_method"] = abyss_buy_ticket_method
        LogTrackingMgr.LOG(args, kwargs)

    # 魂魄镶嵌
    @staticmethod
    def equip_soul(GBID, distinctId, op_uuid, unique_id, equip_id, equip_name, equip_type, equip_grade, equip_quality, equip_power, equip_attrs, soul_attrs_before, soul_attrs_after, cost_item_info, **kwargs):
        args = {}
        args["#account_id"] = GBID
        args["#distinct_id"] = distinctId
        args["#type"] = "track"
    ...
    # 地图探索
    @staticmethod
    def map_exploration(GBID, distinctId, map_id, exploration_type, exploration_num, exploration_state, **kwargs):
        args = {}
        args["#account_id"] = GBID
        args["#distinct_id"] = distinctId
        args["#type"] = "track"
        args["#event_name"] = "map_exploration"
        args["map_id"] = map_id
        args["exploration_type"] = exploration_type
        args["exploration_num"] = exploration_num
        args["exploration_state"] = exploration_state
        LogTrackingMgr.LOG(args, kwargs)

    # 腾讯云检测
    @staticmethod
    def tencent_risk(GBID, distinctId, json_str, **kwargs):
        args = {}
        args["#account_id"] = GBID
        args["#distinct_id"] = distinctId
        args["#type"] = "track"
    ...
    # 战力变化
    @staticmethod
    def power_change(GBID, distinctId, curr_power, pre_power, power_change, op_uuid, power_change_reason, **kwargs):
        args = {}
        args["#account_id"] = GBID
        args["#distinct_id"] = distinctId
        args["#type"] = "track"
        args["#event_name"] = "power_change"
        args["curr_power"] = curr_power
        args["pre_power"] = pre_power
        args["power_change"] = power_change
        args["op_uuid"] = str(op_uuid)
        args["power_change_reason"] = str(power_change_reason)
        LogTrackingMgr.LOG(args, kwargs)

    # 装备栏变化日志
    @staticmethod
    def body_equip_flow(GBID, distinctId, op_uuid, server_id, account_id, game_id, item_id, change_num, body_equip_change_reason, unique_id, detail, **kwargs):
        args = {}
        args["#account_id"] = GBID
        args["#distinct_id"] = distinctId
        args["#type"] = "track"
        args["#event_name"] = "body_equip_flow"
        args["op_uuid"] = str(op_uuid)
        args["server_id"] = server_id
        args["account_id"] = str(account_id)
        args["game_id"] = str(game_id)
        args["item_id"] = item_id
        args["change_num"] = change_num
        args["body_equip_change_reason"] = body_equip_change_reason
        args["unique_id"] = str(unique_id)
    ...
    def LOG(args, kwargs):
        ...
        res['properties']['server_id'] = gameconfig.serverId()
        res['properties']['game_id'] = gameconfig.gameId()
        logData = {
