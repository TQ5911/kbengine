...
class LogTrackingMgr:
    ...
    # 公会信息事件
    @staticmethod
    def Guild_Info(GBID, distinctId, guild_uuid, level, guild_exp, fund_num, gold_num, guild_commission, token_num, src, op_uuid, desc, **kwargs):
        args = {}
        args["#account_id"] = GBID
        args["#distinct_id"] = distinctId
        args["#type"] = "track"
