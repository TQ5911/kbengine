...
class LeaderBoardAvatarLevelRushRankVal(userType.UserSoleType):
    ...
    @staticmethod
    def funcName():
        return 'onLeaderBoardAvatarLevelRushRank'
...
class LeaderBoardAvatarLevelRushRankInfo(object):
    def createObjFromDict(self, dataDict):
        obj = LeaderBoardAvatarLevelRushRankVal(**dataDict)
        return obj
    ...
    def isSameType(self, obj):
        return type(obj) is LeaderBoardAvatarLevelRushRankVal


LeaderBoardAvatarLevelRushRankInstance = LeaderBoardAvatarLevelRushRankInfo()
