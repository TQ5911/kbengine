...
class GlyphData(userType.UserSoleType):
    ...
    def cleanInscriptionEffects(self, owner):
        INFO_MSG("GlyphData-->cleanInscriptionEffects, begin~ ", self.inscriptionEffects)
        self.inscriptionEffects = {}
        INFO_MSG("GlyphData-->cleanInscriptionEffects, end~ ", self.inscriptionEffects)

    def calculateAllInscriptionEffects(self, owner, glyphAffixes):
        INFO_MSG("GlyphData-->calculateAllInscriptionEffects, begin~ ", self.inscriptionEffects)
        self.doCalculateInscriptionEffects(owner, glyphAffixes)
        INFO_MSG("GlyphData-->calculateAllInscriptionEffects, end~", self.inscriptionEffects)
    ...
    def applyInscriptionEffects(self, owner):
        INFO_MSG("GlyphData-->applyInscriptionEffects, clean begin~", self.inscriptionRecords)
        # 1.清理旧的已应用的铭文效果
        ...
        INFO_MSG("GlyphData-->applyInscriptionEffects, clean end~", self.inscriptionRecords)

        INFO_MSG("GlyphData-->applyInscriptionEffects, apply begin~", self.inscriptionEffects)
        # 2.重新应用新的铭文效果
        ...
        INFO_MSG("GlyphData-->applyInscriptionEffects, apply end~", self.inscriptionEffects, self.inscriptionRecords)
    ...
    def getInscriptionSrcSkillId(self, skillId):
        INFO_MSG("GlyphData-->getInscriptionSrcSkillId~", skillId, self.sourceSkillIdx, self.replacedSkillIdx)
