...
namespace KBEngine
{
	...
	public abstract class MonsterBase : ModelEntity
	{
		...
		public virtual void onBelongActIdChanged(UInt32 oldValue) {}
		...
		public virtual void onBelongNameChanged(string oldValue) {}
		
		public virtual void onBelongTeamIdChanged(UInt64 oldValue) {}
		...
		public virtual void onIsBlingChanged(Byte oldValue) {}
			...
			while(stream.length() > 0)
			{
				...
				switch(prop.properUtype)
				{
					...
					case 71:
						...
						break;
					case 390:
						UInt32 oldval_belongActId = belongActId;
						belongActId = stream.readUint32();

						if(prop.isBase())
						{
							if(inited)
								onBelongActIdChanged(oldval_belongActId);
						}
						else
						{
							if(inWorld)
					...
					case 387:
						...
						break;
					case 386:
						string oldval_belongName = belongName;
						belongName = stream.readUnicode();

						if(prop.isBase())
						{
							if(inited)
								onBelongNameChanged(oldval_belongName);
						}
						else
						{
							if(inWorld)
						...
						break;
					case 388:
						UInt64 oldval_belongTeamId = belongTeamId;
						belongTeamId = stream.readUint64();

						if(prop.isBase())
						{
							if(inited)
								onBelongTeamIdChanged(oldval_belongTeamId);
						}
						else
						{
							if(inWorld)
					...
					case 474:
						...
						break;
					case 392:
						Byte oldval_isBling = isBling;
						isBling = stream.readUint8();

						if(prop.isBase())
						{
							if(inited)
								onIsBlingChanged(oldval_isBling);
						}
						else
						{
							if(inWorld)
		...
		public override void callPropertysSetMethods()
		{
			...
			Int32 oldval_adjDebilityAnti = adjDebilityAnti;
			Property prop_adjDebilityAnti = pdatas[195];
			...
			Int32 oldval_adjDebilityEnh = adjDebilityEnh;
			Property prop_adjDebilityEnh = pdatas[196];
			...
			float oldval_adjIgnoreArmor = adjIgnoreArmor;
			Property prop_adjIgnoreArmor = pdatas[45];
			...
			Int32 oldval_adjKnockAnti = adjKnockAnti;
			Property prop_adjKnockAnti = pdatas[199];
			...
			Int32 oldval_adjKnockEnh = adjKnockEnh;
			Property prop_adjKnockEnh = pdatas[200];
			...
			Int32 oldval_atkBless = atkBless;
			Property prop_atkBless = pdatas[20];
			...
			float oldval_baseIgnoreArmor = baseIgnoreArmor;
			Property prop_baseIgnoreArmor = pdatas[49];
			...
			UInt32 oldval_belongActId = belongActId;
			Property prop_belongActId = pdatas[4];
			if(prop_belongActId.isBase())
			{
				if(inited && !inWorld)
					onBelongActIdChanged(oldval_belongActId);
			}
			else
			{
				if(inWorld)
				{
					if(prop_belongActId.isOwnerOnly() && !isPlayer())
					{
					}
					else
					{
			...
			string oldval_belongName = belongName;
			Property prop_belongName = pdatas[7];
			if(prop_belongName.isBase())
			{
				if(inited && !inWorld)
					onBelongNameChanged(oldval_belongName);
			}
			else
			{
				if(inWorld)
				{
					if(prop_belongName.isOwnerOnly() && !isPlayer())
					{
					}
					else
					{
			...
			UInt64 oldval_belongTeamId = belongTeamId;
			Property prop_belongTeamId = pdatas[8];
			if(prop_belongTeamId.isBase())
			{
				if(inited && !inWorld)
					onBelongTeamIdChanged(oldval_belongTeamId);
			}
			else
			{
				if(inWorld)
				{
					if(prop_belongTeamId.isOwnerOnly() && !isPlayer())
					{
					}
					else
					{
			...
			Int32 oldval_debilityAnti = debilityAnti;
			Property prop_debilityAnti = pdatas[207];
			...
			Int32 oldval_debilityEnh = debilityEnh;
			Property prop_debilityEnh = pdatas[208];
			...
			Byte oldval_dunTimeFreezeFlag = dunTimeFreezeFlag;
			Property prop_dunTimeFreezeFlag = pdatas[191];
			...
			float oldval_extraDmg = extraDmg;
			Property prop_extraDmg = pdatas[51];
			...
			float oldval_extraDmgDef = extraDmgDef;
			Property prop_extraDmgDef = pdatas[54];
			...
			float oldval_finalDmg = finalDmg;
			Property prop_finalDmg = pdatas[55];
			...
			float oldval_finalDmgAnti = finalDmgAnti;
			Property prop_finalDmgAnti = pdatas[56];
			...
			Int32 oldval_frozenAnti = frozenAnti;
			Property prop_frozenAnti = pdatas[24];
			...
			Int32 oldval_frozenEnh = frozenEnh;
			Property prop_frozenEnh = pdatas[25];
			...
			float oldval_hitRate = hitRate;
			Property prop_hitRate = pdatas[84];
			...
			Byte oldval_isBling = isBling;
			Property prop_isBling = pdatas[10];
			if(prop_isBling.isBase())
			{
				if(inited && !inWorld)
					onIsBlingChanged(oldval_isBling);
			}
			else
			{
				if(inWorld)
				{
					if(prop_isBling.isOwnerOnly() && !isPlayer())
					{
					}
					else
					{
			...
			Int32 oldval_knockAnti = knockAnti;
			Property prop_knockAnti = pdatas[210];
			...
			Int32 oldval_knockEnh = knockEnh;
			Property prop_knockEnh = pdatas[211];
			...
			Int32 oldval_maxMagicAtk = maxMagicAtk;
			Property prop_maxMagicAtk = pdatas[35];
			...
			Int32 oldval_minPhysicalAtk = minPhysicalAtk;
			Property prop_minPhysicalAtk = pdatas[44];
			...
			float oldval_monsterDmg = monsterDmg;
			Property prop_monsterDmg = pdatas[61];
			...
			float oldval_monsterDmgAnti = monsterDmgAnti;
			Property prop_monsterDmgAnti = pdatas[62];
			...
			float oldval_mortal = mortal;
			Property prop_mortal = pdatas[95];
			...
			Byte oldval_moveAni = moveAni;
			Property prop_moveAni = pdatas[97];
			...
			float oldval_mpCostRatio = mpCostRatio;
			Property prop_mpCostRatio = pdatas[98];
			...
			float oldval_mulBloodSuck = mulBloodSuck;
			Property prop_mulBloodSuck = pdatas[101];
			...
			float oldval_mulBossDmg = mulBossDmg;
			Property prop_mulBossDmg = pdatas[102];
			...
			float oldval_mulFullHp = mulFullHp;
			Property prop_mulFullHp = pdatas[114];
			...
			float oldval_mulFullMp = mulFullMp;
			Property prop_mulFullMp = pdatas[115];
			...
			float oldval_mulHp = mulHp;
			Property prop_mulHp = pdatas[117];
			...
			Int32 oldval_realDmg = realDmg;
			Property prop_realDmg = pdatas[68];
			...
			Int32 oldval_realDmgDef = realDmgDef;
			Property prop_realDmgDef = pdatas[70];
			...
			Int32 oldval_silentAnti = silentAnti;
			Property prop_silentAnti = pdatas[166];
			...
			Int32 oldval_silentEnh = silentEnh;
			Property prop_silentEnh = pdatas[167];
			...
			float oldval_skillCD = skillCD;
			Property prop_skillCD = pdatas[71];
			...
			Int32 oldval_slowAnti = slowAnti;
			Property prop_slowAnti = pdatas[72];
			...
			Int32 oldval_slowEnh = slowEnh;
			Property prop_slowEnh = pdatas[74];
			...
			Int32 oldval_spirit = spirit;
			Property prop_spirit = pdatas[75];
			...
			Int32 oldval_stunAnti = stunAnti;
			Property prop_stunAnti = pdatas[176];
			...
			Int32 oldval_stunEnh = stunEnh;
			Property prop_stunEnh = pdatas[177];
