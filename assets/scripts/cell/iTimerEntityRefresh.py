...
class TimedIntervalsEntityVal(userType.UserSoleType):
    ...
    def __str__(self):
        return f'TimedIntervalsEntityVal(refreshTimedID={self.refreshTimedID}, nextStartTime={self.nextStartTime}, interval={self.interval}, refreshDataList={self.refreshDataList}, nextStartTimeStr={utils.getTimeStrFromTimeStamp(self.nextStartTime)})'
...
class TimeLimitedEntityVal(userType.UserSoleType):
    ...
    def __str__(self):
        return f'TimeLimitedEntityVal(refreshTimedID={self.refreshTimedID}, stageType={self.stageType}, nextStartTime={self.nextStartTime}, interval={self.interval}, refreshDataList={self.refreshDataList}, nextStartTimeStr={utils.getTimeStrFromTimeStamp(self.nextStartTime)})'
