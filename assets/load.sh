...
mysql -h$dbHost -P$dbPort -u$dbUser -p$dbPasswd -e "drop database $dbName"
mysql -h$dbHost -P$dbPort -u$dbUser -p$dbPasswd -e "create database $dbName"
mysql -h$dbHost -P$dbPort -u$dbUser -p$dbPasswd $dbName < $1.sql
