...
protoc -I=%PROTO_SRC_PATH% --python_out=%PROTO_OUT_PATH% ranking.proto ranking_server.proto
protoc -I=%PROTO_SRC_PATH% --python_out=%PROTO_OUT_PATH% gf_ranking.proto gf_ranking_server.proto
...
protoc -I=%PROTO_SRC_PATH% --python_out=%PROTO_OUT_PATH% awardService.proto
protoc -I=%PROTO_SRC_PATH% --python_out=%PROTO_OUT_PATH% gameServerAuction.proto
protoc -I=%PROTO_SRC_PATH% --python_out=%PROTO_OUT_PATH% socializationService.proto
protoc -I=%PROTO_SRC_PATH% --python_out=%PROTO_OUT_PATH% cross_server.proto
protoc -I=%PROTO_SRC_PATH% --python_out=%PROTO_OUT_PATH% subscriptionService.proto
protoc -I=%PROTO_SRC_PATH% --python_out=%PROTO_OUT_PATH% gameServerPersonalInfo.proto
